...
interface BillingLogExportModalProps {
  isOpen: boolean;
  onClose: () => void;
  logs: BillingLog[];
...
export const BillingLogExportModal: React.FC<BillingLogExportModalProps> = ({
  isOpen,
  onClose,
  logs,
  onExport,
  ...
  const availableFields = [
    { id: 'billingLogId', label: 'Billing Log ID' },
    { id: 'clientId', label: 'Client ID' },
    { id: 'clientName', label: 'Client Name' },
    { id: 'billingLogType', label: 'Type' },
    { id: 'description', label: 'Description' },
    { id: 'billingAmount', label: 'Amount' },
    { id: 'billingCurrency', label: 'Currency' },
    { id: 'billingStatus', label: 'Status' },
    { id: 'paymentMethod', label: 'Payment Method' },
    { id: 'transactionId', label: 'Transaction ID' },
    { id: 'subscriptionId', label: 'Subscription ID' },
    { id: 'processedAt', label: 'Processed At' },
    { id: 'billingNotes', label: 'Notes' },
  ];
