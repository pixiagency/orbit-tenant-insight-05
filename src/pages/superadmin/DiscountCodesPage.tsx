...
const MOCK_DISCOUNT_CODES: ActivationCode[] = [
  {
    id: '1',
    code: 'SAVE50PERCENT',
    packageId: '1',
    ...
    status: 'active',
    usedBy: ['TechCorp Inc.', 'StartupXYZ'],
  ...
  },
  {
    ...
    status: 'active',
    usedBy: ['TechCorp Inc.', 'DataFlow Solutions', 'CloudTech Ltd.'],
...
export const DiscountCodesPage = () => {
  const [codes, setCodes] = useState<ActivationCode[]>(MOCK_DISCOUNT_CODES);
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 dark:bg-gray-900 min-h-full">
      <PageHeader
        ...
        description="Generate and manage discount codes for packages"
        breadcrumbs={[
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Filter discount codes by various criteria
            </CardDescription>
          </div>
