...
export const CallLogsSettingsPage: React.FC = () => {
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-50 dark:bg-gray-900 min-h-full">
      <PageHeader
        title="Call Logs & Recording Settings"
        description="Configure call recording, VoIP integration, and system preferences"
        breadcrumbs={[
          { label: 'Settings', href: '/admin/settings' },
          { label: 'Call Logs & Recording' },
        ]}
        showAddButton={false}
      />
