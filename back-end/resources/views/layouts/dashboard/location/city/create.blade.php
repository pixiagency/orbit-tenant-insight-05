...
'title' => trans('app.create_new_city_title'),
'first_list_item' => trans('app.cities'),
'last_list_item' => trans('app.add_city'),
])
{{-- end breadcrumb --}}
            ...
            <div class="card-body">
                ...
                <form action="{{route('locations.sublocation.store')}}" method="post">
                    ...
                    <div class="row row-sm mb-4">
                        ...
                        <div class="col-lg">
                            <div class="form-group">
                                <div class="main-content-label mg-b-5">@lang('app.governorate') *</div>
