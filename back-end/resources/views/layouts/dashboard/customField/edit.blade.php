...
@include('layouts.components.breadcrumb', [
    'title' => trans('app.edit_customField_title'),
    'first_list_item' => trans('app.customField'),
    'last_list_item' => trans('app.edit_customField'),
])
{{-- end breadcrumb --}}
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('custom-fields.update', $customField->id) }}" method="post">
                        ...
                        <div class="col-lg">
                            <div class="form-group">
                                ...
                                >
                                    ...
                                    <option value="dropdown" {{ old('type', $customField->type) == 'dropdown' ? 'selected' : '' }}>Dropdown</option>
                                </select>
                                @error('type')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="row row-sm mb-4" id="options-container" style="display: {{ $customField->type == 'dropdown' ? 'block' : 'none' }};">
                        <div class="col-lg">
                            <div class="form-group">
                                <div class="main-content-label mg-b-5">@lang('app.options')</div>
                                <div id="options-list">
                                    @if ($customField->type == 'dropdown' && !empty($customField->options))
                    ...
                    <div class="card-footer mt-4">
                        <div class="form-group mb-0 mt-3 justify-content-end">
                            <div>
                                ...
                                <a role="button" href="{{ route('custom-fields.index') }}" class="btn btn-primary">
