...
'title' => trans('app.custom-fields_title'),
'first_list_item' => trans('app.custom-fields'),
'last_list_item' => trans('app.all_custom-fields'),
])
{{-- end breadcrumb --}}
        ...
        <div class="card custom-card">
            <div class="card-header">
                <div class="form-group mb-0 mt-3 justify-content-end">
                    <div>
                        <a class="btn btn-primary" href="{{ route('custom-fields.create') }}"><i
