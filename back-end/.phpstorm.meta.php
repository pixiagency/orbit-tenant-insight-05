...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\laragonnew\www\CRM\public\storage' => 'string',
...
'filesystems.links.D:\\laragonnew\\www\\CRM\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','cashier.key','cashier.secret',
...
'cashier.logger','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'central.signup','central.login','central.','central.tiers.buy','central.tiers.index',
'central.tiers.store','central.tiers.show','central.tiers.update','central.tiers.destroy','central.modules.index',
'central.modules.store','central.modules.show','central.modules.update','central.modules.destroy','central.activation-codes.index',
'central.activation-codes.store','central.activation-codes.show','central.activation-codes.update','central.activation-codes.destroy','central.tenants.index',
'central.logout','central.packages.index','central.packages.create','central.packages.store','central.packages.show',
...
'central.','central.','central.','central.subscriptions.index','central.subscriptions.store',
'central.subscriptions.show','central.subscriptions.update','central.subscriptions.destroy','central.activation-codes.index','central.activation-codes.store',
'central.activation-codes.show','central.activation-codes.update','central.activation-codes.destroy','central.invoices.index','central.invoices.store',
'central.invoices.show','central.invoices.update','central.invoices.destroy','users.index','users.store','users.show',
'users.update','users.destroy','teams.index','teams.store','teams.show',
...
'pipelines.update','pipelines.destroy',
'sources.index','sources.store','sources.show','sources.update','sources.destroy',
'reasons.index','reasons.store','reasons.show','reasons.update','reasons.destroy','user.json','error',
'central.','central.login','central.signup','central.signup','central.signin',
'central.home','central.logout','storage.local','login','signup',
'signup','signin','home','profile.index','profile.update',
'industries.index','industries.create','industries.store','industries.show','industries.edit',
'industries.update','industries.destroy','services.index','services.create','services.store',
'services.show','services.edit','services.update','services.destroy','locations.cities.create',
'locations.governorates.create','locations.countries.create','locations.cities.edit','locations.governorates.edit','locations.countries.edit',
'locations.sublocation.store','locations.sublocation.update','locations.index','locations.store','locations.show',
'locations.edit','locations.update','locations.destroy','reasons.index','reasons.create',
'reasons.store','reasons.show','reasons.edit','reasons.update','reasons.destroy',
'resources.index','resources.create','resources.store','resources.show','resources.edit',
'resources.update','resources.destroy','custom-fields.index','custom-fields.create','custom-fields.store',
'custom-fields.show','custom-fields.edit','custom-fields.update','custom-fields.destroy','clients.index',
'clients.create','clients.store','clients.show','clients.edit','clients.update',
'clients.destroy','piplines.index','piplines.create','piplines.store','piplines.show',
'piplines.edit','piplines.update','piplines.destroy','contacts.index','contacts.create',
'contacts.store','contacts.show','contacts.edit','contacts.update','contacts.destroy',
'leads.index','leads.create','leads.store','leads.show','leads.edit',
'leads.update','leads.destroy','role-permissions.index','role-permissions.create','role-permissions.store',
'role-permissions.show','role-permissions.edit','role-permissions.update','role-permissions.destroy','role-permissions.update',
'logout',);
...
'app.actions','app.all_awbs','app.area','app.awb','app.awbs_title',
'app.companies','app.edit_shipment_status','app.email_or_phone','app.hi','app.import instructions',
'app.online','app.support_and_docs','app.there_is_an_error_in_change_awbs_status','app.translation','instructions.address',
...
'validation.password','app.back','app.actual_receipt','app.add','app.add_awb',
'app.add_company','app.add_department','app.add_new_branch','app.add_new_department','app.add_price',
'app.add_receiver','app.add_status','app.add_user','app.additional_kg_price','app.address',
'app.address1','app.address2','app.all_awb_status','app.all_companies','app.all_prices',
'app.all_receivers','app.all_status','app.all_users','app.are_you_sure','app.areas',
'app.industry','app.industry_additional_info','app.industry_code','app.industry_created_successfully','app.industry_history',
'app.industry_info','app.industry_is_reverse','app.industry_pod','app.industry_receiver','app.industry_receiver_info',
'app.industry_receiving_date','app.industry_sender_info','app.industry_status','app.industry_status_page_title','app.industry_status_title',
'app.industries','app.industries_status_changed_successfully','app.industries_title','app.piplines_title','app.piplines',
'app.pipline','app.create_pipline','app.pipline_name','app.Stages','app.all_piplines',
'app.Stage Name','app.Add Stage','app.show_pipline','app.show_pipline_title','app.stage_details',
'app.update','app.edit_pipline','app.pipline_created_successfully','app.pipline_updated_successfully','app.pipline_deleted_successfully',
'app.contents_title','app.contacts','app.contacts_title','app.contact','app.create_new_contact_title',
'app.create_contact','app.add_contact','app.all_contacts','app.edit_contact_title','app.edit_contact',
'app.contact_created_successfully','app.contact_updated_successfully','app.contact_deleted_successfully','app.leads_title','app.leads',
'app.lead','app.all_leads','app.create_new_lead_title','app.edit_lead_title','app.edit_lead',
'app.add_lead','app.services','app.custom_fields','app.select_reason','app.reason',
'app.stage','app.select_stage','app.select_category','app.categories','app.assign_to',
'app.select_sales_representative','app.selected_user_is_not_sales','app.lead_created_successfully','app.lead_updated_successfully','app.lead_deleted_successfully',
'app.role-permissions','app.reasons','app.sources','app.customFields','app.branch',
'app.branch_address','app.branch_address_is_required','app.branch_area_is_required','app.branch_city_is_required','app.branch_data',
'app.branch_name_is_required','app.branch_phone_is_required','app.branches','app.branches_count','app.branches_page_title',
'app.card_number','app.ceo','app.change_status','app.cities','app.city',
'app.code','app.collection','app.comment','app.companies_filter','app.companies_page_title',
'app.companies_receivers','app.company','app.company_name','app.create_area','app.create_branches',
'app.create_city','app.create_companies','app.create_departments','app.create_new_awb_title','app.create_price_tables',
'app.create_receivers','app.create_shipment','app.create_shipment_status','app.create_users','app.created_at',
'app.custom_field1','app.custom_field2','app.custom_field3','app.custom_field4','app.dashboard_settings',
'app.delete','app.delete_area','app.delete_branches','app.delete_city','app.delete_companies',
'app.delete_departments','app.delete_price_tables','app.delete_receivers','app.delete_selected','app.delete_shipment',
'app.delete_shipment_status','app.delete_users','app.department','app.department_data','app.department_name_is_required',
'app.departments','app.departments_count','app.departments_page_title','app.description','app.edit',
'app.edit_area','app.edit_branch','app.edit_branches','app.edit_city','app.edit_companies',
'app.edit_company','app.edit_department','app.edit_departments','app.edit_general_settings','app.edit_price',
'app.edit_price_tables','app.edit_receiver','app.edit_receivers','app.edit_shipment','app.edit_user',
'app.edit_users','app.email','app.end_date','app.export','app.export_pdf',
'app.filter','app.first_download_awb_template','app.first_download_receivers_template','app.first_download_template','app.from',
'app.history','app.images','app.import','app.import_type','app.importation_type',
'app.imports','app.imports_logs','app.increase_percentage','app.increase_price','app.is_final',
'app.lat','app.lng','app.locations','app.login_failed','app.login_successfully',
'app.map_url','app.menu','app.name','app.net_price','app.new',
'app.new_awb_status','app.new_price_table','app.new_shipment','app.new_user','app.no',
'app.no_images','app.notes','app.num_custom_fields','app.password','app.password_confirmation',
'app.payment_type','app.phone','app.phone1','app.phone2','app.pieces',
'app.pod','app.prepare_shipment','app.price','app.price_created_successfully','app.price_table',
'app.price_table_page_title','app.price_tables','app.prices','app.prices_page_title','app.print',
'app.profile_image','app.receiver','app.receiver_branch','app.receiver_name','app.receivers',
'app.receivers_created_successfully','app.receivers_details','app.receivers_page_title','app.receivers_title','app.receiving_branch',
'app.receiving_company','app.reference','app.reset','app.return_price','app.save',
'app.search','app.search_receivers','app.second_step_upload_excel','app.select_area','app.select_branch',
'app.select_city','app.select_company','app.select_department','app.select_status','app.send',
'app.service_type','app.settings','app.shipment','app.shipment_status','app.shipment_type',
'app.show','app.show_dashboard','app.show_receiver','app.sign_in','app.sign_up',
'app.sms','app.something_went_wrong','app.special_price','app.start_date','app.status',
'app.stepper','app.submit','app.success_count','app.success_operation','app.the_awb_status_is_delivered_and_status_cannot_be_changed',
'app.there_is_an_error','app.title','app.to','app.total_count','app.type',
'app.upload_excel_with_properties','app.user','app.user_created_successfully','app.users','app.users_filter',
'app.users_page_title','app.view_area','app.view_branches','app.view_city','app.view_companies',
'app.view_departments','app.view_price_tables','app.view_receivers','app.view_settings','app.view_shipment',
'app.view_shipment_status','app.view_shipment_status_images','app.view_users','app.view_users_details','app.weight',
'app.wight','app.yes','app.zone_price','instructions.code','instructions.email',
'instructions.email_describe','instructions.location',);
